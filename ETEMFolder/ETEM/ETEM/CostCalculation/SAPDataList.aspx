<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SAPDataList.aspx.cs" Inherits="ETEM.CostCalculation.SAPDataList" %>
...
<%@ Register Src="~/Controls/CostCalculation/SAPDataData.ascx" TagName="SAPDataData" TagPrefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="row-fluid">
        <div class="span12">
            <asp:GridView ID="gvSAPDataList" runat="server" CssClass="MainGrid" AutoGenerateColumns="False"
                OnSorting="gvSAPDataList_Sorting" AllowSorting="true" AllowPaging="True" OnPageIndexChanging="gvSAPDataList_PageIndexChanging"
                PageSize="10">
                <Columns>
    ...
    <uc3:SAPDataData ID="ucSAPDataData" runat="server" />
