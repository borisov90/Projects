<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ProductivityAndScrapList.aspx.cs" Inherits="ETEM.CostCalculation.ProductivityAndScrapList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="row-fluid">
        <div class="span12">
            <asp:GridView ID="gvProductivityAndScrap" runat="server" CssClass="MainGrid" AutoGenerateColumns="False"
                OnSorting="gvProductivityAndScrap_Sorting" AllowSorting="true" AllowPaging="True" OnPageIndexChanging="gvProductivityAndScrap_PageIndexChanging"
                PageSize="10">
                <Columns>
