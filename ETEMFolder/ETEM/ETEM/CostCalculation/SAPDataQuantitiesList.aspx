<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SAPDataQuantitiesList.aspx.cs" Inherits="ETEM.CostCalculation.SAPDataQuantitiesList" %>
...
<%@ Register Src="~/Controls/CostCalculation/SAPDataQuantityData.ascx" TagName="SAPDataQuantityData" TagPrefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="row-fluid">
        <div class="span12">
            <asp:GridView ID="gvSAPDataQuantities" runat="server" CssClass="MainGrid" AutoGenerateColumns="False"
                OnSorting="gvSAPDataQuantities_Sorting" AllowSorting="true" AllowPaging="True" OnPageIndexChanging="gvSAPDataQuantities_PageIndexChanging"
                PageSize="10">
                <Columns>
                    ...
                    <asp:BoundField DataField="QuantityTypeName" HeaderText="Type of quantity" SortExpression="QuantityTypeName" />
                    <asp:BoundField DataField="ValueDataRoundFormatted" HeaderText="Value" SortExpression="ValueData" ItemStyle-CssClass="MainGrid_td_item_right" HeaderStyle-Width="150px" />
    ...
    <uc3:SAPDataQuantityData ID="ucSAPDataQuantityData" runat="server" />
    <asp:Panel ID="pnlFilterData" runat="server" Visible="false" CssClass="modalPopup-middle">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="span8">
                    <p>
                        <asp:Label ID="lbQuantityType" runat="server" Text="Type of quantity"></asp:Label>
                    </p>
            ...
            <div class="row">
                <div class="span4">
                    <p>
                        <asp:Label ID="lbValueDataFrom" runat="server" Text="Value from"></asp:Label>
                    </p>
                    <asp:TextBox ID="tbxValueDataFrom" runat="server" MaxLength="19" onkeypress="return isNumeric(event, true);"></asp:TextBox>
                </div>
                <div class="span4">
                    <p>
                        <asp:Label ID="lbValueDataTo" runat="server" Text="Value to"></asp:Label>
                    </p>
