<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AverageOutturnOverTimeList.aspx.cs" Inherits="ETEM.CostCalculation.AverageOutturnOverTimeList" %>
...
<%@ Register Src="~/Controls/CostCalculation/AverageOutturnOverTimeData.ascx" TagName="AverageOutturnOverTimeData" TagPrefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div id="btns-groups-holder">
        <div class="row">
            <div class="span6">
                ...
                <asp:Button ID="btnNew" runat="server" Text="New average outturn over time" OnClick="btnNew_Click" CssClass="btn modalWindow" />
    ...
    <div class="row-fluid">
        <div class="span12">
            <asp:GridView ID="gvAverageOutturnOverTimeList" runat="server" CssClass="MainGrid" AutoGenerateColumns="False"
                OnSorting="gvAverageOutturnOverTimeList_Sorting" AllowSorting="true" AllowPaging="True" OnPageIndexChanging="gvAverageOutturnOverTimeList_PageIndexChanging"
                PageSize="10">
                <Columns>
                    ...
                    <asp:BoundField DataField="ValueOfPressSMS1_RoundFormatted" HeaderText="SMS 1 (kg)" SortExpression="ValueOfPressSMS1_RoundFormatted" />
                    <asp:BoundField DataField="ValueOfPressSMS2_RoundFormatted" HeaderText="SMS 2 (kg)" SortExpression="ValueOfPressSMS2_RoundFormatted" />
                    <asp:BoundField DataField="ValueOfPressBREDA_RoundFormatted" HeaderText="BREDA (kg)" SortExpression="ValueOfPressBREDA_RoundFormatted" />
                    <asp:BoundField DataField="ValueOfPressFARREL_RoundFormatted" HeaderText="FARREL (kg)" SortExpression="ValueOfPressFARREL_RoundFormatted" />
    ...
    <uc3:AverageOutturnOverTimeData ID="ucAverageOutturnOverTimeData" runat="server" />
