<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpensesByCostCentersDataTon.ascx.cs" Inherits="ETEM.Controls.CostCalculation.ExpensesByCostCentersDataTon" %>
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <div class="row tab-content">
                                <div>
                                    <asp:Table ID="tblOfferDataExpenseGroupTon" runat="server" CssClass="GridExpenses width100pc-important"></asp:Table>
                                </div>
                            </div>
                        </asp:TableCell>
                    </asp:TableRow>
