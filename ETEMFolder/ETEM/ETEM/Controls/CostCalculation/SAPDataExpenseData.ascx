<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SAPDataExpenseData.ascx.cs" Inherits="ETEM.Controls.CostCalculation.SAPDataExpenseData" %>
...
<asp:Panel ID="pnlFormData" runat="server" Visible="false" CssClass="modalPopup80pc">
    <div class="newItemPopUp">
        <div class="offset01">
            <h4 id="H1" runat="server">
                <asp:Label ID="lbHeaderText" runat="server" Text="Expense by Cost Center and Type"></asp:Label></h4>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="span8">
                <p>
                    <asp:Label ID="lbExpenseType" runat="server" Text="Type of expense"></asp:Label></p>
        ...
        <div class="row">
            <div class="span4">
                <p>
                    <asp:Label ID="lbValueData" runat="server" Text="Value for the last 12 months (EUR)"></asp:Label></p>
